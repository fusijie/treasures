...
declare module cc {	
	...
	*/
	...
	``` 
	*/
	export function removeSelf(isNeedCleanUp : boolean =  true): ActionInstant;	
	/**
	...
	*/
	...
	``` 
	*/
	export function callFunc(selector: Function, selectorTarget: any = null, data: any = null): ActionInstant;	
	/**
	!#en
	...
	*/
	...
	``` 
	*/
	export function color(r: number = 0, g: number = 0, b: number = 0, a: number = 255): Color;	
	/**
	...
	*/
	...
	``` 
	*/
	export function rect(x: number = 0, y: number = 0, w: number = 0, h: number = 0): Rect;	
	/**
	...
	*/
	...
	``` 
	*/
	export function v2(x: number|any = 0, y: number = 0): Vec2;	
	/**
	...
	``` 
	*/
	export function p(x: number|any = 0, y: number = 0): Vec2;	
	/**
	!#en Check whether a point's value equals to another.
	!#zh 判断两个向量是否相等。
	@param point1 point1
	...
	*/
	...
	export class Node extends _BaseNode {		
		...
		*/
		...
		``` 
		*/
		on(type: string, callback: (param: Event) => void, target?: any, useCapture: boolean = false): Function;		
		/**
		!#en
		...
		``` 
		*/
		off(type: string, callback: Function, target?: any, useCapture: boolean = false): void;		
		/**
		...
		*/
		...
		``` 
		*/
		getContentSize(ignoreSizeProvider: boolean = false): Size;		
		/**
		!#en
		...
		*/
		...
		@param cascadeColorEnabled cascadeColorEnabled
	...
	export class CollisionManager implements EventTarget {		
		...
		*/
		...
		``` 
		*/
		once(type: string, callback: (param: Event) => void, target?: any, useCapture: boolean = false): void;		
		/**
		!#en
	...
	export class Animation extends Component implements EventTarget {		
		...
		*/
		removeClip(clip: AnimationClip, force: boolean = false): void;		
		/**
		!#en
	...
	export class Component extends Object {		
		...
		*/
		...
		``` 
		*/
		schedule(callback: Function, interval: number = 0, repeat: number = cc.macro.REPEAT_FOREVER, delay: number = 0): void;		
		/**
		...
		``` 
		*/
		scheduleOnce(callback: Function, delay: number = 0): void;		
		/**
	...
	export class ScrollView extends Component {		
		...
		``` 
		*/
		scrollToBottom(timeInSecond: number = 0, attenuated: boolean = true): void;		
		/**
		...
		``` 
		*/
		scrollToTop(timeInSecond: number = 0, attenuated: boolean = true): void;		
		/**
		...
		``` 
		*/
		scrollToLeft(timeInSecond: number = 0, attenuated: boolean = true): void;		
		/**
		...
		``` 
		*/
		scrollToRight(timeInSecond: number = 0, attenuated: boolean = true): void;		
		/**
		...
		``` 
		*/
		scrollToTopLeft(timeInSecond: number = 0, attenuated: boolean = true): void;		
		/**
		...
		``` 
		*/
		scrollToTopRight(timeInSecond: number = 0, attenuated: boolean = true): void;		
		/**
		...
		``` 
		*/
		scrollToBottomLeft(timeInSecond: number = 0, attenuated: boolean = true): void;		
		/**
		...
		``` 
		*/
		scrollToBottomRight(timeInSecond: number = 0, attenuated: boolean = true): void;		
		/**
		...
		``` 
		*/
		scrollToOffset(offset: Vec2, timeInSecond: number = 0, attenuated: boolean = true): void;		
		/**
		...
		*/
		...
		``` 
		*/
		scrollToPercentHorizontal(percent: number, timeInSecond: number = 0, attenuated: boolean = true): void;		
		/**
		...
		``` 
		*/
		scrollTo(anchor: Vec2, timeInSecond: number = 0, attenuated: boolean = true): void;		
		/**
		...
		*/
		scrollToPercentVertical(percent: number, timeInSecond: number = 0, attenuated: boolean = true): void;		
		/**
	...
	export class eventManager {		
		...
		*/
		static pauseTarget(node: Node, recursive: boolean = false): void;		
		/**
		...
		@param recursive recursive 
		*/
		static resumeTarget(node: Node, recursive: boolean = false): void;		
		/**
		...
		*/
		...
		@param recursive recursive 
		*/
		static removeListeners(listenerType: number|Node, recursive: boolean = false): void;		
		/**
	...
	export class loader extends Pipeline {		
		...
		*/
		...
		``` 
		*/
		static loadRes(url: string, type: {new (): cc.Asset}, progressCallback: Function, completeCallback: ((error: Error, resource: any) => void)|null): void;
		static loadRes(url: string, type: {new (): cc.Asset}, completeCallback: (error: Error, resource: any) => void): void;
		static loadRes(url: string, type: {new (): cc.Asset}): void;
		...
		``` 
		*/
		static loadResArray(url: string[], type: {new (): cc.Asset}, progressCallback: Function, completeCallback: ((error: Error, resource: any[]) => void)|null): void;
		static loadResArray(url: string[], type: {new (): cc.Asset}, completeCallback: (error: Error, resource: any[]) => void): void;
		static loadResArray(url: string[], type: {new (): cc.Asset}): void;
		...
		``` 
		*/
		static loadResDir(url: string, type: {new (): cc.Asset}, progressCallback: Function, completeCallback: ((error: Error, resource: any[], urls: string[]) => void)|null): void;
		static loadResDir(url: string, type: {new (): cc.Asset}, completeCallback: (error: Error, resource: any[], urls: string[]) => void): void;
		static loadResDir(url: string, type: {new (): cc.Asset}): void;
	...
	export class CallbacksInvoker extends _CallbacksHandler {		
		...
		*/
		bindKey(key: string, remove: boolean = false): Function;	
	}	
	...
	export class SpriteFrame extends Asset implements EventTarget {		
		...
		*/
		setTexture(textureOrTextureFile: string|Texture2D, rect: Rect = null, rotated: boolean = false, offset: Vec2 = cc.v2(0,0), originalSize: Size = rect.size): boolean;		
		/**
	...
	export class textureCache {		
		...
		*/
		...
		``` 
		*/
		getTextureColors(texture: HTMLImageElement): any[];		
		/**
		#en get all textures
		#zh 获取所有贴图 
		*/
		...
		*/
		...
		``` 
		*/
		removeTexture(texture: HTMLImageElement): void;		
		/**
		...
		*/
		...
		@param texture texture 
		*/
		cacheImage(path: string, texture: HTMLImageElement|HTMLCanvasElement): void;		
		/**
	...
	export class _BaseNode extends Object implements EventTarget {		
		...
		*/
		...
		``` 
		*/
		removeChildByTag(tag: number, cleanup: boolean = true): void;		
		/**
		!#en
...
declare module sp {	
	...
	export class Skeleton extends cc._RendererUnderSG {		
		...
		*/
		...
		@param delay delay 
		*/
		addAnimation(trackIndex: number, name: string, loop: boolean, delay: number = 0): sp.spine.TrackEntry;		
		/**
	...
	export class SkeletonData extends cc.Asset {		
		...
		@param quiet quiet 
		*/
		getRuntimeData(quiet: boolean = false): sp.spine.SkeletonData;	
	}	
...
declare module cc._decorator {	
	...
	*/
	...
	``` 
	*/
	export function property(options?: {type?: any; url?: cc.RawAsset; visible?: boolean; displayName?: string; tooltip?: string; multiline?: boolean; readonly?: boolean; min?: number; max?: number; step?: number; range?: number[]; slide?: boolean; serializable?: boolean; editorOnly?: boolean; override?: boolean; animatable?: boolean; default?: any}): Function;
	...
	*/
	...
	``` 
	*/
	export function requireComponent(requiredComponent: {new (): cc.Component}): Function;	
	/**
	!#en
...
declare module cc.js {	
	...
	*/
	export function value(obj: any, prop: string, value: any, writable: boolean = false, enumerable: boolean = false): void;	
	/**
	...
	@param enumerable enumerable 
	*/
	export function getset(obj: any, prop: string, getter: Function, setter: Function, enumerable: boolean = false): void;	
	/**
	...
	*/
	export function get(obj: any, prop: string, getter: Function, enumerable: boolean = false, configurable: boolean = false): void;	
	/**
	...
	@param configurable configurable 
	*/
	export function set(obj: any, prop: string, setter: Function, enumerable: boolean = false, configurable: boolean = false): void;	
	/**
	...
	*/
	...
	@param writable writable 
	*/
	export function obsolete(obj: any, obsoleted: string, newPropName: string, writable: boolean = false): void;	
	/**
	...
	@param writable writable 
	*/
	export function obsoletes(obj: any, objName: any, props: any, writable: boolean = false): void;	
	/**
	...
	*/
	...
	export class array {		
		...
		*/
		static indexOf(searchElement: any, fromIndex: number = 0): number;		
		/**
